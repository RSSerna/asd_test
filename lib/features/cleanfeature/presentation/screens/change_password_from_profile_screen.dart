...
class ChangePasswordFromProfileScreen extends StatelessWidget {
...
class _FormValidatorState extends State<_FormValidator> {
  ...
  @override
  Widget build(BuildContext context) {
    final changeForgottenPasswordFormKey = GlobalKey<FormState>();
    return BlocConsumer<CleanBloc, CleanState>(listener: (context, state) {
      ...
      return Column(
        ...
        children: [
          const _AppBar(),
          Form(
            key: changeForgottenPasswordFormKey,
            child: Column(
              children: [
                Row(
                  children: [
